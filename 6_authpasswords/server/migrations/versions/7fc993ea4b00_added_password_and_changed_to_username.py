"""added password and changed to username

Revision ID: 7fc993ea4b00
Revises: ecf0257b1295
Create Date: 2024-04-29 10:36:07.453152
...
revision = '7fc993ea4b00'
down_revision = 'ecf0257b1295'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('uq_users_user', type_='unique')
...
def downgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint('uq_users_user', ['user'])
